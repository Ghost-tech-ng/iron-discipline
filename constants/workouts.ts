  ...
  tuesday: {
    ...
    exercises: [
      ...
      },
      {
        ...
        repsMax: 15,
        restSeconds: 60,
        notes: 'Each side — resist rotation, do not twist',
      },
      {
        id: 'dead_bug',
        name: 'Dead Bug',
  ...
  wednesday: {
    ...
    exercises: [
      ...
      },
      {
        ...
        repsMax: 15,
        restSeconds: 60,
        notes: 'Each side — high to low. Obliques + side abs',
      },
    ],
    warmUp: [
  ...
  friday: {
    ...
    exercises: [
      ...
      },
      {
        ...
        repsMax: 24,
        restSeconds: 60,
        notes: 'Hold a plate or DB — obliques + rotational strength',
      },
    ],
    warmUp: [
  ...
  saturday: {
    ...
    exercises: [
      ...
      },
      {
        ...
        repsMax: 15,
        restSeconds: 60,
        notes: 'Each side — anti-rotation core stability',
      },
    ],
    warmUp: [
